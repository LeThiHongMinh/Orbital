  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-red-50 rounded-sm z-50 border-b border-n-6 lg:bg-n-8/90 lg:backdrop-blur-sm">
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 py-4">
        ...
        <p className="ml-5 font-palanquin text-3xl font-bold z-10">
          NUSTudy Seeker
        </p>
        <nav
          className={`${
        ...
        >
          <div className="relative text-black z-10 flex flex-col space-y-20 items-center m-auto lg:space-x-10 lg:flex-row lg:space-y-0">
            {navigation.map((item) => (
              <a
                key={item.label}
                href={item.href}
                ...
                } lg:font-semibold m-auto stroke-black block shadow-2xl relative font-palanquin font-bold lg:flex lg:mx-auto lg:bg-n-8 leading-normal text-2xl transition-colors ${
        ...
        <div className="container">
          {isAuth ? (
            ...
            <div className="hidden lg:flex lg:flex-row">
              <NavLink
                className="font-palanquin font-bold text-2xl lg:flex lg:mx-auto"
                to="/login"
              >
                <span>Login</span>
              </NavLink>
