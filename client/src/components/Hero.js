  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-wl:padding-x pt-28">
        <p className="text-4xl text-left font-semibold font-montserrat text-coral-red text-bold">
          Dora The Kids
        </p>
        <h1 className="text-black mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82] font-bold">
          <span className="text-black shadow-lg xl:whitespace-nowrap relative z-10 pr-10">
            The Best Place
          </span>
          <br />
          <span className="shadow-lg space-x-30">To Find</span>
          <span className="text-red-700 shadow-lg inline-block mt-3">
            Study Partner
          </span>
        </h1>
